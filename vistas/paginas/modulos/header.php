			...
			<div class="row">
				...
				<div class="col-7 col-sm-5 col-md-4 col-lg-2 col-xl-3 my-3 d-flex mt-lg-3 logotipo">
					...
					<a href="<?php echo $ruta; ?>inicio">
						<img data-nite-src="img/logo-medelo-de-negocio.png" class="img-fluid pt-1">
					</a>
				</div>
				<!-- BOTONERA -->
				<div class="d-none d-lg-block col-lg-8 col-xl-6 p-0 pt-lg-2 mt-lg-1 pt-xl-4 botonera">					
					<ul class="nav justify-content-lg-left justify-content-xl-end">						
						<li class="nav-item">
							<a class="nav-link text-white" href="#modelo">Crear modelo</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="#comoIniciar">Como iniciar</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="#blog">Blog</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="#faq">Preguntas frecuentes</a>
						</li>						
						<li class="nav-item">
				...
				<div class="col-5 col-sm-7 col-md-8 col-lg-2 col-xl-3 p-0 pt-4 pt-lg-2 mt-lg-1 pt-xl-4">
					...
					<div class="mr-2 mr-lg-0 float-right pt-1 ingresos">						
						<button class="btn botonNaranja btn-sm">							
